...
return (
  <div className="relative">
    <Input
      ...
      type={type}
      className={cn(
        "peer h-12 w-full rounded-md border border-input bg-gray-100 px-4 py-2 text-sm shadow-sm transition-all duration-160",
    ...
    <Label
      htmlFor={id}
      className={cn(
        "absolute left-4 top-1/2 -translate-y-1/2 text-sm text-muted-foreground transition-all duration-160 ease-in-out",
